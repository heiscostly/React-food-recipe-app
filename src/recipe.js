...
function recipe ({tittle,calories,image, ingredients}){
  return (
    <div className={style.recip}>
      ...
      <p style={{padding:"10px", display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", listStyle:"none"}}> <h2>INGREDIENTS</h2>{ingredients.map(ingredient => (

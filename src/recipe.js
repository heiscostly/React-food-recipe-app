...
function recipe({ tittle, calories, image, ingredients }) {
  return (
    <div className={style.recip}>
      <h1 style={{ display: "flex", color: "black", fontSize: "1rem", padding: "0" }}>{tittle}</h1>
      ...
      {/* <h2>CALORIES</h2>
      <p>{calories}</p> */}
      <img style={{ width: "40%", borderRadius: "10px", height: "", paddingBottom:"10px" }} src={image} alt="myimage" />
